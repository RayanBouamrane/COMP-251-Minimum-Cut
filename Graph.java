...
public class Graph
{
    ...
    public void contractEdge(Edge edge_to_contract)
    {
        ...
        {
            if ((getEdge(i).node_1 == u || getEdge(i).node_1 == v) &&
                (getEdge(i).node_2 == u || getEdge(i).node_2 == v))
            {
                getEdges().remove(getEdge(i));
                i--;
            }
            else if ((getEdge(i).node_1 == u || getEdge(i).node_2 == u))
            {
                newEdges.add(getEdge(i));
            }
        }
        removeNode(u);
        for (Edge e : newEdges)
